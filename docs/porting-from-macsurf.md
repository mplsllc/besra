...
1. **Core baseline** — import upstream NetSurf's libhubbub/libdom/libcss/
   libparserutils/libwapcaplet + content/desktop at a known-good tag. Stand up a
   Linux frontend (GTK or framebuffer) and confirm it renders a real page. *No MacSurf
   code yet — establish a clean, building base.*
