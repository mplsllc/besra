		...
		const char *charset, const char *url, bool allow_quirks)
{
	...
	/* Register any custom-property declarations carried by this inline
	 * style="..." attribute into the doc-global inline-extras table.
	 * Lets a parent's `style="--header-tile: url(...)"` resolve for
	 * descendant elements whose author CSS references
	 * `var(--header-tile)`. Failure is non-fatal: the sheet still works
	 * for the cascading element itself, only the cross-element
